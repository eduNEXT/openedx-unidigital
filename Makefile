...
format: # format code with black and isort
	black openedx_unidigital setup.py manage.py test_settings.py
	isort openedx_unidigital setup.py manage.py test_settings.py
...
extract_translations: ## extract strings to be translated, outputting .mo files
	cd openedx_unidigital && i18n_tool extract --no-segment

compile_translations: ## compile translation files, outputting .po files for each supported language
	cd openedx_unidigital && i18n_tool generate

detect_changed_source_translations:
	cd openedx_unidigital && i18n_tool changed
...
pull_translations:
	find openedx_unidigital/conf/locale -mindepth 1 -maxdepth 1 -type d -exec rm -r {} \;
	atlas pull $(OPENEDX_ATLAS_ARGS) translations/openedx-unidigital/openedx_unidigital/conf/locale:openedx_unidigital/conf/locale
...
dummy_translations: ## generate dummy translation (.po) files
	cd openedx_unidigital && i18n_tool dummy
