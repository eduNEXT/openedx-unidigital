#!/usr/bin/env python
"""
Package metadata for openedx_unidigital.
"""
import os
import re
import sys
...
VERSION = get_version("openedx_unidigital", "__init__.py")
...
setup(
    name="openedx-unidigital",
    version=VERSION,
    description="""An Open edX plugin for the Unidigital project""",
    long_description=README + "\n\n" + CHANGELOG,
    author="eduNEXT",
    author_email="technical@edunext.co",
    url="https://github.com/eduNEXT/openedx-unidigital",
