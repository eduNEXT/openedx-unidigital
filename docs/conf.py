...
"""
openedx-unidigital documentation build configuration file.
...
html_context = {
    ...
    "github_repo": 'openedx-unidigital',  # Repo name
...
#
html_theme_options = {
    "repository_url": "https://github.com/eduNEXT/openedx-unidigital",
...
#
# html_title = 'openedx-unidigital v0.1.0'
...
texinfo_documents = [
    (top_level_doc, project_title, documentation_title,
     author, project_title, 'An Open edX plugin for the Unidigital project',
     'Miscellaneous'),
]
...
def on_init(app):  # pylint: disable=unused-argument
    ...
    check_call([apidoc_path, '-o', docs_path, os.path.join(root_path, 'openedx_unidigital'),
                os.path.join(root_path, 'openedx_unidigital/migrations')])
